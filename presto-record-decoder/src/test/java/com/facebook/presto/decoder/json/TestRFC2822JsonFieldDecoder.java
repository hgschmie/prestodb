...
public class TestRFC2822JsonFieldDecoder
{
    ...
    public void testBasicFormatting()
    {
        ...
        DecoderTestColumnHandle row3 = new DecoderTestColumnHandle("", 2, createColumnName("row3"), BigintType.BIGINT, "a_number", RFC2822JsonFieldDecoder.NAME, null, false, false, false);
        DecoderTestColumnHandle row4 = new DecoderTestColumnHandle("", 3, createColumnName("row4"), BigintType.BIGINT, "a_string", RFC2822JsonFieldDecoder.NAME, null, false, false, false);

        DecoderTestColumnHandle row5 = new DecoderTestColumnHandle("", 4, createColumnName("row5"), createVarcharType(100), "a_number", RFC2822JsonFieldDecoder.NAME, null, false, false, false);
        DecoderTestColumnHandle row6 = new DecoderTestColumnHandle("", 5, createColumnName("row6"), createVarcharType(100), "a_string", RFC2822JsonFieldDecoder.NAME, null, false, false, false);
