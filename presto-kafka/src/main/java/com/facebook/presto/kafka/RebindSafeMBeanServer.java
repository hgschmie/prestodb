        ...
        implements MBeanServer
{
    ...
    public static final MBeanServer wrap(MBeanServer mbeanServer)
    {
        return new RebindSafeMBeanServer(mbeanServer);
    }

    public static final MBeanServer wrapPlatformServer()
    {
        return new RebindSafeMBeanServer(ManagementFactory.getPlatformMBeanServer());
    }

    private RebindSafeMBeanServer(MBeanServer mbeanServer)
    {
